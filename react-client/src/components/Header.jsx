            ...
            if (index === props.data.array.length-1) {
                return(
                    <p className="LastPlayer">
                        ...
                        <div className="Votes"><img className="UpVoteArrow" src="https://i.imgur.com/8yJfihe.png" onClick={props.upVote}/> 0 <img className="DownVoteArrow" src="https://i.imgur.com/ZA2BSbi.png" onClick={props.downVote}/>360</div>
