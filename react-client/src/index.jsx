...
class App extends React.Component {
  ...
  render() {
    return (
      <div>
        <button onClick={this.makeMagic} className='MagicButton'>Make Magic </button><div className="wrapper"></div>

        {this.state.gotCreatedSong === false ? <Loading /> : null }
        <Header upVote={this.upVote} downVote={this.downVote} data={this.state}/>
      </div>
    );
  }
}
